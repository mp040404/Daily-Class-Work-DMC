...
//	}
	...
	public void descinorder(Node trav) {
		if(trav == null)
			return ;
		descinorder(trav.right);
		System.out.print(trav.data + " , ");
		descinorder(trav.left);
		
	}
	
	public void descinorder() {
		System.out.print("DESCIN : ");
		descinorder(root);
		System.out.println();
	}
