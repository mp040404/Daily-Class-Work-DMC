...
mysql> select FIRST_NAME, HIRE_DATE,JOB_ID
    ->  from employees
...
mysql> select FIRST_NAME , SALARY , COMMISSION_PCT , HIRE_DATE from employees
    -> where salary < 10000;
+-------------+---------+----------------+------------+
...
mysql> select * from employees
    ...
    -> and salary > 10000 and commission_pct is null ;
+-------------+------------+-----------+-------+----------------+------------+--------+----------+----------------+------------+---------------+
| EMPLOYEE_ID | FIRST_NAME | LAST_NAME | EMAIL | PHONE_NUMBER   | HIRE_DATE  | JOB_ID | SALARY   | COMMISSION_PCT | MANAGER_ID | DEPARTMENT_ID |
+-------------+------------+-----------+-------+----------------+------------+--------+----------+----------------+------------+---------------+
|         114 | Den        | Li        | DLI   | 1.515.555.0114 | 2012-12-07 | PU_MAN | 11000.00 |           NULL |        100 |            30 |
